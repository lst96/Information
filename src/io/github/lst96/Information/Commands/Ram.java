...
public class Ram implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if ((sender.isOp()) || (sender.hasPermission("information.ram"))) {
			...
			sender.sendMessage(ChatColor.GOLD + "[Uptime]: " +  ChatColor.WHITE + (int) (diff / 604800000) + "w " + (int) (diff / 86400000 % 7) + "d " + (int) (diff / 3600000 % 24) + "h " + (int) (diff / 60000 % 60) + "m " + (int) (diff / 1000 % 60) + "s");
			sender.sendMessage(ChatColor.GOLD + "[Tps]: " +  color + Tps.getTPS());
			sender.sendMessage(ChatColor.GOLD + "[Maximum Ram]: " +  ChatColor.WHITE + runtime.maxMemory() / 1024L / 1024L + " MB");
			sender.sendMessage(ChatColor.GOLD + "[Allocated Ram]: " +  ChatColor.WHITE + runtime.totalMemory() / 1024L / 1024L + " MB");
			sender.sendMessage(ChatColor.GOLD + "[Used Ram]: " +  ChatColor.WHITE + (runtime.totalMemory() - runtime.freeMemory()) / 1024L / 1024L + " MB");
			sender.sendMessage(ChatColor.GOLD + "[Free Ram]: " +  ChatColor.WHITE + runtime.freeMemory() / 1024L / 1024L + " MB");
