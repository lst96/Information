    ...
    public boolean  onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args)
    {
    	...
    	if(commandLabel.equalsIgnoreCase("online")){
    		if ((sender.isOp()) || (sender.hasPermission("information.online"))) {
    		   sender.sendMessage(ChatColor.DARK_RED + "[Information]" + " " + ChatColor.GREEN + Bukkit.getOnlinePlayers().length + " " + ChatColor.YELLOW + "of" + " " + ChatColor.GREEN + Bukkit.getMaxPlayers());
    	    return true;
    		}
